"""Add some field in likedThreads entity

Revision ID: 094a171e5e86
Revises: ebe275511390
Create Date: 2024-11-21 00:37:38.760863
...
revision: str = '094a171e5e86'
down_revision: Union[str, None] = 'ebe275511390'
...
def downgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['course_id'], ['threads.course_id'], ),
